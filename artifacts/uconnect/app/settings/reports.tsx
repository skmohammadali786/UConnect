...
const styles = StyleSheet.create({
  ...
  infoBar: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 10, borderRadius: 12, borderWidth: 1, padding: 12 },
  infoText: { fontSize: 13, fontFamily: "Inter_500Medium", textAlign: "center" },
