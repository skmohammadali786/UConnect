...
export default function NotificationsScreen() {
  ...
  const handlePress = (n: Notification) => {
    ...
    if (n.actionType === "post") {
      ...
      n.actionType === "internship" ||
      n.actionType === "internship_application" ||
      ...
      n.actionType === "event" ||
      n.actionType === "event_attendee_request" ||
        ...
        <View style={styles.headerActions}>
          {notifications.length > 0 && (
            <TouchableOpacity
              ...
              style={[styles.markAllBtn, { backgroundColor: "#EF444415" }]}
            >
              <Text style={[styles.markAll, { color: "#EF4444" }]}>
                Delete all
              </Text>
            </TouchableOpacity>
          )}
          ...
          >
            <View
              style={[
                ...
                {
                  backgroundColor:
                    (NOTIFICATION_COLORS[item.type] || "#6B7280") + "20",
                },
              ]}
            >
            ...
            <View style={styles.textWrap}>
              <View style={styles.titleRow}>
                ...
                {!item.isRead ? (
                  ...
                  >
                    <Text
                      style={[styles.newPillText, { color: colors.primary }]}
                    >
                      NEW
                    </Text>
                  </View>
