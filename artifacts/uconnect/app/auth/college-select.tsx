...
const styles = StyleSheet.create({
  ...
  titleSection: { paddingHorizontal: 20, gap: 8, marginBottom: 20, alignItems: "center" },
  stepBadge: { alignSelf: "center", paddingHorizontal: 10, paddingVertical: 4, borderRadius: 20 },
